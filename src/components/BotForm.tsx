...
export const BotForm = ({ bot, onSave, onCancel }: BotFormProps) => {
  ...
  const openRouterModels = [
    ...
    { value: "google/gemini-2.0-flash-thinking-experimental", label: "Google: Gemini 2.0 Flash Thinking Experimental (free) - $0.00/$0.00 - 40k ctx" },
    { value: "google/gemini-experimental-1114", label: "Google: Gemini Experimental 1114 (free) - $0.00/$0.00 - 40k ctx" },
    { value: "google/gemini-experimental-1121", label: "Google: Gemini Experimental 1121 (free) - $0.00/$0.00 - 40k ctx" },
    { value: "google/gemini-experimental-1206", label: "Google: Gemini Experimental 1206 (free) - $0.00/$0.00 - 2097k ctx" },
    { value: "google/gemini-flash-1.5", label: "Google: Gemini Flash 1.5 - $0.07/$0.30 - 1000k ctx" },
    { value: "google/gemini-flash-1.5-8b", label: "Google: Gemini Flash 1.5 8B - $0.04/$0.15 - 1000k ctx" },
    { value: "google/gemini-flash-1.5-8b-experimental", label: "Google: Gemini Flash 1.5 8B Experimental - $0.00/$0.00 - 1000k ctx" },
    { value: "google/gemini-flash-1.5-experimental", label: "Google: Gemini Flash 1.5 Experimental - $0.00/$0.00 - 1000k ctx" },
    { value: "google/gemini-flash-2.0-experimental", label: "Google: Gemini Flash 2.0 Experimental (free) - $0.00/$0.00 - 1048k ctx" },
